...
TAX_RATE = 0.03  # ✅ 3% دمغة وضريبة (داخلية - غير معروضة)
...
# ==========================================
# 3. جلب الأسعار مع 3% دمغة (داخلية)
# ==========================================
def get_market_data():
    """جلب الأسعار من مصادر متعددة مع إضافة 3% دمغة وضريبة (داخلية)"""
    ...
    # ===== حساب أسعار الجرامات مع 3% دمغة (داخلية) =====
    ...
    for karat in [24, 22, 21, 18]:
        ...
        # ✅ إضافة 3% دمغة وضريبة (داخلية - غير معروضة)
