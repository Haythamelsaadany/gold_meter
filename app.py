...
with col3:
    st.markdown(f"<div class='price-card'><h4 style='color:#00d4ff;'>🏅 الأوقية محلياً</h4><h2>{usd_price * usd_egp:,.2f} ج.م</h2></div>", unsafe_allow_html=True)    st.markdown(f"<div class='price-card'><h4 style='color:#00d4ff;'>🏅 الأوقية محلياً</h4><h2>{usd_price * usd_egp:,.2f} ج.م</h2></div>", unsafe_allow_html=True)st.write("---")
