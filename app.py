...
def main():
    ...
    with tab5:
        ...
        with col_h1:
            ...
            st.markdown("""
            المعرف أو الـ **Chat ID** هو رقم رقمي فريد يمنحه تليجرام لحسابك الشخصي لتلقي الرسائل الآلية. للحصول عليه بكل سهولة:
        ...
        with st.accordion("هل هناك أي رسوم على تفعيل خدمات التنبيه داخل الموقع؟"):
            st.write("الخدمة مجانية بالكامل ومطورة برمجياً لخدمة كافة المهتمين بأسواق الذهب وتداول العملات في مصر بشكل لحظي ودقيق.")
            
        with st.accordion("الموقع يخبرني بوجود قيود تحديث في البورصة، فما السبب؟"):
    ...
    # تذييل الصفحة الرسمي بالحقوق المطلوبة verbatim
